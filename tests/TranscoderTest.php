...
OK
INPUT;
        $output = '[{"seq":"1","status":"REC READ","from":"+5511388382882","timestamp":"22/05/05 16:04:23+08","text":"00480065006C006C006F00200077006F0072006C0064002000C1"}]';

        $this->assertEquals(Transcoder::transcode($input), $output);
    }
}
?>